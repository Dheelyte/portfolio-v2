        ...
        <div ref={containerRef} className="slide projects" id="projects">
            ...
            <div className="project">
                ...
                <div className="project-meta">
                    ...
                    <a className="link" href="https://realchat-v2.onrender.com/" target="_blank" rel="noreferrer">
            ...
            <a className="link projects-more" href="https://github.com/Dheelyte" target="_blank" rel="noreferrer">See more</a>
        </div>
    )
}